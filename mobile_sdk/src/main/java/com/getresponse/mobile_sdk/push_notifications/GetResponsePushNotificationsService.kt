...
class GetResponsePushNotificationsService (
    ...
    @DrawableRes private var notificationIcon: Int? = null
    ...
    internal fun configure(applicationId: String, entryPoint: String, secretKey: String, notificationIcon: Int?, channelsConfig: List<AndroidChannel>, installationUUID: String, enableDebug: Boolean, isAvailable: Boolean) {
    ...
    suspend fun consent(lang: String, externalId: String, email: String?, fcmToken: String) {
        getApi(entryPoint, createJWTToken(applicationId, secretKey, installationUUID), enableDebug).consent(ConsentModel(lang, externalId, email, fcmToken))
    }
